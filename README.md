...
We propose to develop a device that assesses the environment of a fish tank by observing temperature, water quality and other factors. The device may take pictures of the tank and use a recommender system to assess the images and data to make user recommendations.
